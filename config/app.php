...
return [
    ...
    'App' => [
        ...
        'cssBaseUrl' => 'css/',
        'jsBaseUrl' => 'js/',
        'pdfBaseUrl' => env('APP_PDF_BASE_URL', 'pdf/'),
        'paths' => [
    ...
    'Cache' => [
        ...
        '_cake_core_' => [
            ...
            'serialize' => true,
            'duration' => env('APP_CACHE_DURATION', '+1 years'),
    ...
    'Session' => [
        'defaults' => 'php',
        'timeout' => 1440, // Minutes: 1 days
        'autoRegenerate' => true,
        'ini' => [
            'session.gc_maxlifetime' => 86400, // Seconds: 1 days
        ],
        'cookie' => 'CAKEPHP'
    ],

    'S3BaseUrl' => env('S3_BASE_URL', 'https://s3-ap-northeast-1.amazonaws.com/voice.tac-school.co.jp/'),
    'PreviewUrl' => env('PREVIEW_URL', 'https://edit.tac-school.co.jp/edit01/view.php?pageId=16299'),
];

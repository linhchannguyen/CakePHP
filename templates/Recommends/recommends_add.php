...
<p>※印は必須入力項目です。</p>
<div class="frm">
    <?php echo $this->Form->create(null, $option = array('url' => ['controller' => 'Recommends', 'action' => 'recommendsAddFinish'], 'type' => 'post', 'enctype' => 'multipart/form-data')); ?>
    <dl>
        <dt>校舎選択 (※)</dt>
        <dd>
            <div>
        ...
        <dd>
            <div>
                ...
                echo $this->Form->input('radio_link', array(
                    ...
                    'value'    => intval($recommends_form['radio_link']),
                    'div'      => false,
                    'label'    => true,
                    'class'    => 'form01',
        ...
        <dd>
            <div>
                ...
                echo $this->Form->input('radio_sub_url1', array(
                    ...
                    'value'    => intval($recommends_form['radio_image']),
                    'div'      => false,
                    'label'    => true,
                    'class'    => 'form01',
                    'style'    => "margin-right:4.5px;",

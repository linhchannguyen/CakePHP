...
<body>
	<div id="container">
		...
		<div id="content">
            ...
            <?php echo $this->Html->link('ログアウト', array('controller' => 'SuccessfulCandidates', 'action' => 'logout'),array('class' => 'edit_link')); ?>
            <?php if (!empty($self)): ?>
                <?php if ($self['role_id'] == HIGHEST ): ?>
                    <?php echo $this->Html->link('ユーザー一覧　', array('controller' => 'SuccessfulCandidates', 'action' => 'userLists'),array('class' => 'edit_link')); ?>
                    <?php echo $this->Html->link('講座一覧　', array('controller' => 'SuccessfulCandidates', 'action' => 'categoryLists'),array('class' => 'edit_link')); ?>
                <?php endif; ?>
            <?php endif; ?>
